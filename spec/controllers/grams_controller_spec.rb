...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy" do
    it "shouldnt allow users who didn create the gram to destroy it" do
  ...
  describe "grams#update" do
    it "shouldnt let users who didnt create the hram update it" do
      p = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
    ...
    it "shouldnt let unauthorized users create a gram" do
      p = FactoryGirl.create(:gram)
